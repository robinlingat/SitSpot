// SitSpot — Données de démonstration
...
export const BENCHES = [
  {
    ...
    tags: [
      { icon: 'tree', label: 'Ombragé' },
      { icon: 'food', label: 'Pique-nique' },
      { icon: 'eye', label: 'Belle vue' },
    ],
    distance: '120 m',
  ...
  },
  {
    ...
    tags: [
      { icon: 'leaf', label: 'Au calme' },
      { icon: 'tree', label: 'Verdure' },
    ],
    distance: '600 m',
    intents: ['calm'],
    photos: 1,
  ...
  },
  {
    ...
    status: { tone: 'green', label: 'Propre' },
    tags: [
      { icon: 'eye', label: 'Panorama' },
      { icon: 'sun', label: 'Coucher de soleil' },
    ],
    distance: '1,2 km',
    intents: ['view', 'sun'],
    photos: 7,
  ...
  {
    id: 'b6',
    name: 'Banc du Trocadéro',
    area: 'Jardins du Trocadéro · 16e',
    x: 14, y: 26,
    score: null, count: 0,
...
export const INTENTS = [
  { id: 'picnic', icon: 'coffee',    label: 'Pique-nique' },
  { id: 'view',   icon: 'image',     label: 'Paysage'     },
  { id: 'calm',   icon: 'wind',      label: 'Au calme'    },
  { id: 'sun',    icon: 'sun',       label: 'Ensoleillé'  },
  { id: 'near',   icon: 'navigation',label: 'Le + proche' },
];

export const REVIEW_TAGS = [
  'Ombragé', 'Ensoleillé', 'Vue agréable', 'Au calme',
  'Bruyant', 'Propre', 'Sale', 'Dossier confortable',
  'Accessible PMR', 'Proche transports', 'Vue sur eau', 'Vue sur parc',
];
