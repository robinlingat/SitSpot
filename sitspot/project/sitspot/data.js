// SitSpot — sample data
window.SS_BENCHES = [
  { id:'b1', name:'Banc du parc Monceau', area:'Parc Monceau · Paris 8e', x:34, y:40, score:4.3, count:28,
  ...
  { id:'b2', name:'Banc des quais', area:'Quai de Seine · Paris 4e', x:62, y:52, score:4.7, count:51,
  ...
  { id:'b3', name:'Banc square Louise', area:'Square Louise Michel · 18e', x:20, y:61, score:3.8, count:12,
  ...
  { id:'b4', name:'Banc de la butte', area:'Parc de Belleville · 20e', x:76, y:30, score:4.5, count:34,
    status:{tone:'green',label:'Propre'},
  ...
  { id:'b5', name:'Allée des tilleuls', area:'Jardin du Luxembourg · 6e', x:50, y:70, score:4.1, count:19,
    status:{tone:'green',label:'Propre'},
  ...
  { id:'b6', name:'Banc du Trocadéro', area:'Jardins du Trocadéro · 16e', x:14, y:26, score:null, count:0,
...
window.SS_RTAGS = ['Ombragé','Ensoleillé','Vue agréable','Au calme','Bruyant','Propre','Sale','Dossier confortable','Accessible PMR','Proche transports','Vue sur eau','Vue sur parc'];

window.SS_USER = { name:'Alex Martin', pseudo:'alexm', benchCount:3, reviewCount:12 };
